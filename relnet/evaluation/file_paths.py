...
class FilePaths:
    ...
    def __init__(self, parent_dir, experiment_id, setup_directories=True):
        ...
        self.cleaned_graphs_dir = self.real_world_graphs_dir / DataPreprocessor.CLEANED_DATA_DIR_NAME
        self.processed_graphs_dir = self.real_world_graphs_dir / DataPreprocessor.PROCESSED_DATA_DIR_NAME
